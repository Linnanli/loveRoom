    ...
    <div class="middle-wrapper">
      ...
      <div class="day-contain-warp">
        <div class="ob-alert" v-if="showAlert">
          ...
          <div class="OBtype2" v-if="showAlert==4">
            <div class="more-box">
              ...
              <!--选择户型-->
              <div class="box">
                <input class="houseType-item-input" type="number" v-model="message.housetype" placeholder="如:三室一厅">
                <!-- <span class="houseType-item-text">居</span> -->
                <!-- <checker v-model="houseType" default-item-class="houseType-item" selected-item-class="houseType-item-selected">
                    <checker-item value="1">不限</checker-item>
                    <checker-item value="2">一居</checker-item>
                    <checker-item value="3">二居</checker-item>
                    <checker-item value="4">三居</checker-item>
                  </checker> -->
              </div>
              <!--选择户型 end -->
        ...
        <div class="daily-list-wrapper" id="mescroll">
          ...
          <div>
            <div class="daily-list-box clearfix" v-for="val in houseInfoList" @click="toDayRentDetail(val)" v-if="houseInfoList[0]">
              ...
              <div class="daily-list-right">
                ...
                <article>
                  <p class="clearfix">
                    <span>{{val.house.housetype}}·{{val.house.acreage | m2}}</span>
                    <em>¥{{val.house.cost}}</em>
                  </p>
                  <p>
                    <i></i>
...
export default {
  ...
  data() {
    return {
      ...
      showAlert: false,
      priceList: [{
        name: '不限金额', value: null
      }, {
        name: '30万以下', value: '300000,less'
      }, {
        name: '30-40万', value: '300000-400000,among'
      }, {
        name: '40-50万', value: '400000-500000,among'
      }, {
        name: '50-60万', value: '500000-600000,among'
      }, {
        name: '60-80万', value: '600000-800000,among'
      }, {
        name: '80万元以上', value: '800000,than'
      }],
